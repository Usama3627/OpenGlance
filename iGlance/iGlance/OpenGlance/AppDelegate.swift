...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    // Sparkle 2 updater controller. Retained to keep the updater alive.
    ...
    func applicationWillFinishLaunching(_ notification: Notification) {
        ...
        // Sparkle 2: create the standard updater controller which starts the
        // updater and manages the update checking lifecycle.
        ...
        if !controller.updater.automaticallyChecksForUpdates {
            ...
            DDLogInfo("Set 'SUEnableAutomaticChecks' to \(controller.updater.automaticallyChecksForUpdates)")
        }
    }

    func applicationDidFinishLaunching(_ notification: Notification) {
        DDLogInfo("OpenGlance did launch")
        ...
        // Show main window immediately for debug logging
        self.showMainWindow()
    }
    ...
    /**
     * This function is called when the 'About OpenGlance' button in the app menu is clicked
     */
    ...
    */
    ...
    /**
    * This function is called when the user selects 'OpenGlance > Preferences...'
    */
