    ...
    private func setupProgrammaticLayout() {
        ...
        let sections = [
            SettingsFormSection(title: "System Monitor", rows: [
                SettingsFormRow(left: memoryUsageCheckbox, right: nil)
            ]),
            SettingsFormSection(title: "Usage Graph Style", rows: [
                SettingsFormRow(label: "Graph Type", subtitle: "Select how memory usage metrics are plotted", control: graphSelector),
                SettingsFormRow(left: usageGraphBorderCheckbox, right: nil),
                SettingsFormRow(label: "Primary Color", subtitle: "Main color used for plotting memory usage", control: usageColorWell),
