...
enum SidebarButton: CaseIterable {
    ...
    var instance: SidebarButtonID {
        switch self {
        case .Dashboard:
            return SidebarButtonID(buttonViewID: "DashboardButtonView", mainViewStoryboardID: "DashboardStoryboardID", symbolName: "rectangle.grid.2x2")
        case .Cpu:
            return SidebarButtonID(buttonViewID: "CpuButtonView", mainViewStoryboardID: "CpuStoryboardID", symbolName: "cpu")
        case .Memory:
            return SidebarButtonID(buttonViewID: "MemoryButtonView", mainViewStoryboardID: "MemoryStoryboardID", symbolName: "memorychip")
        case .Network:
            return SidebarButtonID(buttonViewID: "NetworkButtonView", mainViewStoryboardID: "NetworkStoryboardID", symbolName: "network")
        case .Fan:
            return SidebarButtonID(buttonViewID: "FanButtonView", mainViewStoryboardID: "FanStoryboardID", symbolName: "fan")
        case .Battery:
            return SidebarButtonID(buttonViewID: "BatteryButtonView", mainViewStoryboardID: "BatteryStoryboardID", symbolName: "battery.100")
        case .Disk:
            return SidebarButtonID(buttonViewID: "DiskButtonView", mainViewStoryboardID: "DiskStoryboardID", symbolName: "internaldrive")
        case .Settings:
            return SidebarButtonID(buttonViewID: "SettingsButtonView", mainViewStoryboardID: "SettingsStoryboardID", symbolName: "gearshape")
        }
    }
}
...
class SidebarViewController: NSViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
            ...
            // set the storyboard ids and native SF Symbols for each sidebar item
        for sidebarButton in SidebarButton.allCases {
            ...
            // set the icon ids
            buttonView.symbolName = sidebarButton.instance.symbolName
        }
