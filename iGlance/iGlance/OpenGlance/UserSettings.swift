...
struct IGlanceUserSettings: Codable {
    ...
    /// Keeps the dashboard focused on the four live signals most users need.
    var compactDashboard: Bool = false
    ...
    init(from decoder: Decoder) throws {
        ...
        if let decodedCompactDashboard = try? container.decodeIfPresent(Bool.self, forKey: .compactDashboard) {
            self.compactDashboard = decodedCompactDashboard
        }
...
public class UserSettings {
    ...
    private let userSettingsKey: String = "OpenGlanceUserSettings"
    ...
    func exportUserSettings() {
        ...
        savePanel.title = "Export OpenGlance settings"
    ...
    func importUserSettings() {
        ...
        openPanel.title = "Import OpenGlance settings"
